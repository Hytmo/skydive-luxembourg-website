export const faqItems = {
  "en": [
    {
      ...
      "a": "Yes. Tandem passengers must be at least 14 years old (with written parental consent if under 18) and weigh no more than 90 kg (200 lb) fully clothed. There is no formal upper age limit, but you must be in reasonable health. Please tell us in advance about any medical conditions."
    },
    {
    ...
    },
    {
      ...
      "a": "If we cancel because of weather or technical reasons, you can rebook. If you cancel more than 7 days in advance, you can rebook for another day; less than 7 days before the jump, cancellation is only possible with a medical certificate. Bookings are non-refundable but can be transferred to another person. No-shows forfeit the booking."
    },
    {
      "q": "Will I get photos or video of my jump?",
      "a": "Yes - every tandem booking includes a video of your jump, filmed by your instructor on a handcam. An upgrade to an outside cameraflyer is possible on request, subject to availability."
    }
  ],
  "fr": [
    {
      "q": "Y a-t-il des limites de poids et d'âge pour un tandem ?",
      "a": "Oui. Les passagers tandem doivent avoir au moins 14 ans (avec autorisation parentale écrite pour les mineurs) et peser au maximum 90 kg (200 lb), tout habillés. Il n'y a pas de limite d'âge supérieure formelle, mais vous devez être en bonne santé raisonnable. Merci de nous signaler à l'avance toute condition médicale."
    },
    {
  ...
  "de": [
    ...
    },
    {
      ...
      "a": "Wenn wir wegen Wetter oder technischen Gründen absagen, kannst du umbuchen. Wenn du mehr als 7 Tage im Voraus stornierst, kannst du auf einen anderen Tag umbuchen; weniger als 7 Tage vor dem Sprung ist eine Stornierung nur mit ärztlichem Attest möglich. Buchungen sind nicht erstattungsfähig, können aber auf eine andere Person übertragen werden. Bei Nichterscheinen verfällt die Buchung."
    },
    {
      "q": "Bekomme ich Fotos oder ein Video meines Sprungs?",
      "a": "Ja - jede Tandembuchung enthält ein Handcam-Video deines Sprungs, gefilmt von deinem Lehrer. Ein Upgrade auf einen Außenkameramann ist auf Anfrage möglich, je nach Verfügbarkeit."
    }
  ],
  "lu": [
    {
      "q": "Gibt es Gewiichts- an Altersgrenzen fir einen Tandemsprong?",
      "a": "Ja. Tandem-Passagiere müssen mindestens 14 Joer alt sein (mit schriftlicher Einverständniserklärung der Eltern unter 18 Joern) an dürfen voll bekleidet höchstens 90 kg (200 lb) wiegen. Eine formale Obergrenze beim Alter gibt es nicht, aber du musst in angemessener gesundheitlicher Verfassung sein. Bitte teile uns medizinische Besonderheiten vorab mit."
    },
    {
    ...
    },
    {
      ...
      "a": "Wenn mir wegen Wieder oder technischen Gründen absagen, kannst du umbuchen. Wenn du mehr als 7 Tage im Voraus stornierst, kannst du auf einen anderen Tag umbuchen; weniger als 7 Tage vor dem Sprung ist eine Stornierung nur mit ärztlichem Attest möglich. Buchungen sind nicht erstattungsfähig, können aber auf eine andere Person übertragen werden. Bei Nichterscheinen verfällt die Buchung."
    },
    {
      "q": "Bekomme ich Fotos oder ein Video meines Sprongs?",
      "a": "Ja - jede Tandembuchung enthält ein Handcam-Video vum Sprong, gefilmt vum Instrukteren. Ein Upgrade auf einen Außenkameramann ist auf Anfrage möglich, je nach Verfügbarkeit."
    }
  ]
};
